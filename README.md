...
|---|---|---|---|
| Семинар (аудио) | 30 мин | 0.06 | ~2 мин |
| Урок STEM (видео) | 1 ч 31 мин | ~0.07 | ~6 мин |

Бюджет RTF 0.4 — укладываемся с большим запасом. pyannote 1,5 часа держит,
в память не упирается.

## Железо

Целевой сервер — RTX A4000:

- архитектура Ampere, sm_86
- 16 ГБ VRAM
- CUDA 13.x

Куратор заявлял GTX 1080, по факту в машине A4000. Точность вычислений —
`float16`.
